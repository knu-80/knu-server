...
public enum BusinessErrorCode implements ErrorCode {
     ...
     */
    ENTITY_NOT_FOUND(HttpStatus.NOT_FOUND, "C006", "대상을 찾을 수 없습니다."),
    RESOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, "C007", "요청한 리소스를 찾을 수 없습니다."),

    /*
     * 405 METHOD_NOT_ALLOWED: 허용되지 않은 Request Method 호출
     */
    METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "C008", "허용되지 않은 메서드입니다."),

    /*
     * 409 CONFLICT: 리소스 충돌 (중복 데이터 등)
     */
    ALREADY_EXISTS(HttpStatus.CONFLICT, "C009", "이미 존재하는 데이터입니다."),
